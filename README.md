...
PC와 아이폰에서 같은 공유 코드로 접속해 암기장을 실시간 공유하는 PWA입니다.
...
이 주소는 PC가 꺼져 있어도 접속할 수 있습니다. PC와 아이폰에서 같은 공유 코드를 입력하면 같은 클라우드 암기장을 사용합니다.
...
- 내용 편집 화면은 현재 세부 목록의 원문 전체를 보여줍니다. 기존 내용을 고치거나 아래에 새 줄을 추가한 뒤 저장하면 카드가 다시 만들어집니다.
- 한 암기장 안에 여러 세부 목록을 만들 수 있고, 각 세부 목록은 원문과 카드가 따로 저장됩니다.
- 정답을 탭하면 3초 동안 공개됩니다.
